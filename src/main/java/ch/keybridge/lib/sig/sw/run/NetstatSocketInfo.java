...
/**
 * @deprecated `netstat` is deprecated; use `ss`
 *
 ...
 */
@Deprecated
public class NetstatSocketInfo {
   ...
   */
  public static Collection<NetstatSocketInfo> getAllSockets() throws Exception {
    Collection<NetstatSocketInfo> sockets = new HashSet<>();
    /**
    ...
    for (String entry : SIGUtility.execute("netstat", "-an4")) {// throws Exception
      try {
        sockets.add(NetstatSocketInfo.parseNetstatEntry(entry));
   ...
   */
  public static NetstatSocketInfo parseNetstatEntry(String entry) throws UnknownHostException, NullPointerException, IllegalArgumentException {
    ...
    NetstatSocketInfo socket = new NetstatSocketInfo();
  ...
  public boolean equals(Object obj) {
    ...
    final NetstatSocketInfo other = (NetstatSocketInfo) obj;
